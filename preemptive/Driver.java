...
public class Driver {
	...
	static PCB q2[]=null;
	static int q2Size=0;
	static int q2CurrentExecution=-1;
	...
	static void executeQ1() {
		...
		//preempt any running process from q2
		q2CurrentExecution=-1;
	...
	static void executeQ2() {
		...
		//a process from q2 is currently running
		if(q2CurrentExecution!=-1) {
			shortestIndex=q2CurrentExecution;
		}//end if current
	
		
		
		//no process from q2 is currently running
		else {
			shortestIndex=findShortest(q2);
			q2CurrentExecution=shortestIndex;
		}//else current
